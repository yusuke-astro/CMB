...
#Vect1degc = rot_z(rot_x(rot_psi(vec,beta,psi),phi),eta)
rot_psi(vec,beta,psi)[0]
...
plt.figure()
hp.mollview(I_lu,title="Hit count map in Ecliptic coordinates", unit="Hit number", norm="hist")
hp.graticule()
